      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground">
            TRx <span className="text-primary">WEB</span> Admin
          </h1>
        ...
        <div className="bg-card rounded-2xl shadow-xl border border-border p-8 flex flex-col gap-4">
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center gap-3 w-full px-4 py-3 rounded-xl border border-border bg-background hover:bg-muted transition-colors text-sm font-medium text-foreground disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {loading ? (
