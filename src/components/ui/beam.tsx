      ...
      >
        ...
        <defs>
          <motion.linearGradient
            ...
            id="grad1"
          >
            <stop stopColor="hsl(var(--color-primary))" stopOpacity="0" />
            <stop stopColor="hsl(var(--color-primary))" />
            <stop offset="0.325" stopColor="hsl(var(--color-primary))" />
            <stop offset="1" stopColor="hsl(var(--color-primary))" stopOpacity="0" />
          </motion.linearGradient>
        </defs>
      </svg>
      <svg
